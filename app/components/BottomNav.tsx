...
function BottomNavContent() {
  ...
  const iconBaseClass = "p-1.5 px-3 sm:px-5 rounded-full transition-all duration-300 flex items-center justify-center";
  const labelClass = "text-[9px] sm:text-[10px] font-bold transition-colors duration-300 tracking-tight";
    ...
    <div className="fixed bottom-0 left-0 w-full bg-white/95 backdrop-blur-md border-t border-gray-100 flex justify-around items-center pb-safe pt-2 h-[80px] z-50 shadow-[0_-10px_20px_-5px_rgba(0,0,0,0.03)]">
      ...
      <Link href="/dashboard/pipeline" prefetch={true} className={navItemClass}>
        <div className={`${iconBaseClass} ${isActive('/dashboard/pipeline') ? 'bg-orange-500 text-white shadow-md shadow-orange-100 translate-y-0' : 'bg-transparent text-gray-400 group-hover:bg-orange-50 group-active:scale-90'}`}>
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="9" y1="3" x2="9" y2="21"></line><line x1="15" y1="3" x2="15" y2="21"></line></svg>
        </div>
