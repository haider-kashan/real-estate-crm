...
import NotificationCenter, { ReminderItem } from './NotificationCenter'; // <--- IMPORT NEW COMPONENT
...
export default function HeaderBar({ 
  ...
  // Removed local isNotifOpen state (handled inside NotificationCenter now)
    ...
    <div className={`sticky top-0 z-30 shadow-sm ${bgColor}`}>
      ...
      {isFilterOpen && (
        <div className="px-4 pb-4 grid grid-cols-2 gap-3 animate-in slide-in-from-top-2 bg-black/5 p-4 backdrop-blur-sm">
           {/* ... Filters content (No changes here) ... */}
